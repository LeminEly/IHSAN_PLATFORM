    ...
    <div style={{ maxWidth: "820px", margin: "0 auto" }}>
      ...
      >
        ...
        <div
          style={{
            background:
              "linear-gradient(135deg, var(--g-950) 0%, var(--g-800) 60%, var(--g-700) 100%)",
            padding: "2.5rem",
            position: "relative",
            overflow: "hidden",
          }}
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              ...
              {need.expiry_date && (
                ...
                >
                  ⏳ Expire le{" "}
                  {new Date(need.expiry_date).toLocaleDateString("fr-FR")}
                </span>
              )}
            </div>
          </div>
        ...
        >
                    ...
                    {need.validator.validator && (
                      ...
                      >
                        ...
                        <span style={{ color: "var(--muted)" }}>
                          {need.validator.validator.total_deliveries} livraisons
                        </span>
                      </div>
                    )}
                  </div>
          ...
          <Section title="Localisation" icon="📍">
            ...
            >
              ...
              <div>
                <div style={{ fontWeight: 600, color: "var(--g-700)" }}>
                  {need.location_quarter}
                </div>
          ...
          >
            <div>
              ...
              >
                {parseFloat(need.estimated_amount).toLocaleString()}{" "}
                <span style={{ fontSize: "1.125rem", color: "var(--g-500)" }}>
                  MRU
                </span>
              </div>
            </div>
            <Link
              ...
              style={{
                ...
                fontSize: "1rem",
                textDecoration: "none",
                boxShadow: "0 6px 20px rgba(30,82,40,.3)",
                transition: "all .2s",
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 10px 28px rgba(30,82,40,.4)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 6px 20px rgba(30,82,40,.3)";
              }}
            >
              💚 Financer ce besoin
            </Link>
