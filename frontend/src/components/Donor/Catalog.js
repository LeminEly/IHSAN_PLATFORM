  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          {needs.length} besoin{needs.length !== 1 ? "s" : ""} disponible
          {needs.length !== 1 ? "s" : ""} · En attente de financement
        </p>
      </div>
      ...
      >
        ...
        {(filters.category || filters.quarter) && (
          <button
            onClick={() =>
              setFilters({ category: "", quarter: "", sort: "priority" })
            }
        ...
        >
          {[1, 2, 3, 4, 5, 6].map((i) => (
            ...
            >
              ...
              <div
                className="skeleton"
                style={{ height: 14, width: "50%", marginBottom: 20 }}
              />
          ...
          {needs.map((need, i) => (
            ...
            >
              ...
              <div
                style={{
                  height: "3px",
                  background: `linear-gradient(90deg, ${PRIORITY_COLORS[need.priority] || "#9ca3af"}, transparent)`,
                }}
              />
              ...
              <div style={{ padding: "1.25rem" }}>
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: "0.72rem",
                      fontWeight: 600,
                      color: PRIORITY_COLORS[need.priority] || "var(--muted)",
                    }}
                  >
                ...
                >
                  {need.description?.substring(0, 90)}
                  {need.description?.length > 90 ? "…" : ""}
                </p>
