        ...
        >
          ...
          <div
            style={{
              ...
              height: "2px",
              background:
                "linear-gradient(90deg, transparent, var(--gold), var(--gold-l), transparent)",
              opacity: 0.7,
            }}
          />
                ...
                <div>
                  ...
                  >
                    {[
                      [
                        "Montant",
                        `${parseFloat(verification.transaction.amount).toLocaleString()} MRU`,
                      ],
                      [
                        "Date",
                        new Date(verification.transaction.date).toLocaleString(
                          "fr-FR",
                        ),
                      ],
                      [
                        "Besoin financé",
                        verification.transaction.need?.title || "—",
                      ],
                    ].map(([label, value]) => (
                      <div
                        key={label}
                    ...
                    >
                      ...
                      <Link
                        to={`/transaction/${verification.transaction.id}`}
                        style={{
                          fontSize: "0.875rem",
                          color: "var(--g-600)",
                          fontWeight: 500,
                ...
                <div>
                  <div
                    style={{
                      fontWeight: 600,
                      fontSize: "0.875rem",
                      color: isBlockchain ? "#1e40af" : "#6d28d9",
                      marginBottom: "4px",
                    }}
                  >
                    {isBlockchain
                      ? "Enregistré sur Polygon Amoy Testnet"
                      : "Mode SHA-256 Local"}
                  </div>
                  <p
                    style={{
                      fontSize: "0.8125rem",
                      color: isBlockchain ? "#1e3a8a" : "#5b21b6",
                      lineHeight: 1.6,
                    }}
                  >
                    {isBlockchain
