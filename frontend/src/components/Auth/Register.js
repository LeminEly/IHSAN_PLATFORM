  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.role === "validator") {
      if (!files.id_card || !files.selfie) {
        setError("Carte d'identité et selfie requis");
        setLoading(false);
        return;
      }
  ...
  const roles = [
    {
      key: "donor",
      label: "Donneur",
      desc: "Faites des dons, suivez leur impact",
      icon: "💚",
      color: "#dcfce7",
      border: "#86efac",
    },
    {
      key: "validator",
      label: "Validateur",
      desc: "Validez les besoins sur le terrain",
      icon: "✅",
      color: "#ede9fe",
      border: "#c4b5fd",
    },
    {
      key: "partner",
      label: "Partenaire",
      desc: "Restaurant ou commerce prestataire",
      icon: "🏪",
      color: "#fef9c3",
      border: "#fde047",
    },
  ...
  return (
    <div style={{ maxWidth: "600px", margin: "0 auto", padding: "2rem 1rem" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "2rem" }}>
        ...
        >
          Rejoignez la plateforme de charité transparente
        </p>
      </div>
            ...
            >
              <div
                style={{
                  ...
                  fontWeight: 600,
                  boxShadow:
                    step === s.n ? "0 4px 14px rgba(30,82,40,.3)" : "none",
                  transition: "all .3s",
                }}
              >
                {step > s.n ? "✓" : s.n}
              ...
              <span
                style={{
                  fontSize: "0.72rem",
                  color: step === s.n ? "var(--g-600)" : "var(--muted)",
            ...
            {i < STEPS.length - 1 && (
              <div
                style={{
                  flex: 2,
                  height: 2,
                  background: step > s.n ? "var(--g-500)" : "#e5e7eb",
            ...
            <>
              {formData.role === "donor" && (
                <div style={{ textAlign: "center", padding: "2.5rem 1rem" }}>
                  ...
                  >
                    Les donneurs peuvent s'inscrire directement.
                  </p>
                </div>
              )}
    ...
    <div>
      ...
      >
        ...
        <span
          style={{
            fontSize: "0.8125rem",
            color: file ? "var(--g-600)" : "var(--muted)",
