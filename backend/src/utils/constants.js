...
export const SMS_TEMPLATES = {
  ...
  WELCOME_DONOR: '🙏 IHSAN: Merci de rejoindre IHSAN ! Vous pouvez maintenant explorer les besoins.',
  WELCOME_VALIDATOR: '🤝 IHSAN: Bienvenue ! Votre demande de validateur est en cours de vérification.',
  WELCOME_PARTNER: '🏪 IHSAN: Bienvenue ! Votre demande de partenariat est en cours de vérification.',
  ...
  DONATION_MADE: '✅ IHSAN: Un don de {amount} MRU pour "{title}" a été effectué. Veuillez confirmer la remise.',
  PAYMENT_RECEIVED: '💰 IHSAN: Paiement reçu de {amount} MRU pour "{title}". Vérifiez votre compte mobile money.',
